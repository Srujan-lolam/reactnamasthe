import RestaurentCard, { RestaurentPromoted } from "./RestaurentCard";
...
const Body = () => {
  ...
  const PromotedRestaurent = RestaurentPromoted(RestaurentCard);
  ...
  const handleClick = () => {
    ...
    setSearchResults(filteredListOfRestaurents);
  };
    ...
    <div className="body">
      ...
      <div className="flex flex-wrap justify-evenly">
        {searchResults.map(
          (res) => (
            // false ? (
            // <PromotedRestaurent key={res.info.id} res1={res} />
            // ) : (
